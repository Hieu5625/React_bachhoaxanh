...
function CreateInvoice() {
  ...
  const handleAddDetail = () => {
    ...
    // Tính tổng tiền mới cho sản phẩm
    ...
    if (existingDetailIndex !== -1) {
      ...
      // Cập nhật hóa đơn và tổng tiền
      setInvoice((prev) => ({
        ...prev,
        details: updatedDetails,
        TONGTIEN: prev.TONGTIEN - oldTotal + newTotal, // Thay đổi tổng tiền
      }));
    } else {
      ...
      setInvoice((prev) => ({
        ...
        TONGTIEN: prev.TONGTIEN + calculatedTotal, // Cộng thêm tổng tiền mới
      }));
    }

    // Reset lại chi tiết sản phẩm sau khi thêm
